...
При использовании языка программирования R и библиотеки arrow задания были успешно выполнены.

## Вывод 

Apache Arrow - хорошее средство для решения задач с большими данными и анализа информации о сетевом трафике